...
def main():
    ...
    train_nalist_path = "C:\\Users\\jplabuser\\data\\shanghaitech\\processed\\ShanghaiTech_GCN_train_nalist.npy"
    train_data_path = "C:\\Users\\jplabuser\\data\\shanghaitech\\processed\\ShanghaiTech_GCN_train_features.npy"
    ...
    pseudo_labels_list = generate_improved_pseudo_labels(
        ...
        use_prototype_swap=True,  
        swap_threshold=0.8  # 70% 이상이면 swap
    )
